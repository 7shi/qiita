...
記事 [`../../haskell-io-history.md`](../../haskell-io-history.md)
...
この検証は当初 `series/haskell-intro/check/stream-io/` にあったが、
歴史を単発記事へ分離したのに合わせてここへ移した。
シリーズ本編（継続モナド 超入門）からは記事経由で参照する。
